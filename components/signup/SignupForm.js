...
function SignupForm() {
  ...
  const handleNameAdd = (firstName, lastName, phoneNumber, company, email) => {
    projectfirestore
      .collection("users")
      .add({
        firstName: firstName,
      ...
      <form className="w-[800px] mx-auto mt-24 h-screen">
        ...
        <button
          onClick={(e) => {
            ...
            handleNameAdd(firstName, lastName, phoneNumber, company, email);
          }}
          type="submit"
          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 md:w-full dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-8"
        >
          Submit
        </button>
      </form>
